...
layout = [  
    ...
    [sg.Text('Выбор протокола', size=(15, 1)), sg.InputCombo(("Привзяка к биту на основе симметричной криптографии","Протокол подбрасывания монеты на основе однонаправленной функции","Экспоненциальный протокол подбрасывнания монеты"), size=(70, 3))],
    [sg.Submit(), sg.Cancel()], 
